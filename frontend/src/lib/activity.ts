...
export const ACTIVITY_META: Record<ActivityEventType, { label: string; icon: LucideIcon; tone: Tone }> = {
  ...
  [ActivityEventType.ResultHighlighted]: { label: "Highlighted a result", icon: Heart, tone: "primary" },
  [ActivityEventType.ResultUnhighlighted]: { label: "Removed a highlight", icon: Heart, tone: "muted" },
